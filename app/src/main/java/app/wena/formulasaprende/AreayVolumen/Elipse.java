...
public class Elipse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elipse);
        ...
        altura = (TextInputLayout) findViewById(R.id.radioa);
        base = (TextInputLayout) findViewById(R.id.radiob);
    ...
    public void mostrarInfo(){
        ...
        epicDialog.setContentView(R.layout.area_elipse);
