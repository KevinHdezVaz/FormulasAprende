...
public class aplicacion_crecimiento_poblacional extends AppCompatActivity {
    ImageView imagen2;
    PhotoViewAttacher photo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aplicacion_crecimiento_poblacional);
    ...
    imagen2 =(ImageView)findViewById(R.id.zoomcre);
