...
public class anualidad_simple extends AppCompatActivity {
    ImageView imagen,imagen2;
    PhotoViewAttacher photo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_anualidad_simple);
        ...
        imagen =(ImageView)findViewById(R.id.anualidad1);
        photo = new PhotoViewAttacher(imagen);

        imagen2 =(ImageView)findViewById(R.id.anualidad2);
