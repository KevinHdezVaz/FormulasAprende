...
public class hiperbola_children extends AppCompatActivity {
    ImageView imagen;
    PhotoViewAttacher photo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hiperbola_children);
        ...
        imagen =(ImageView)findViewById(R.id.hiperbolaz);
