...
public class EcuacionVariablesSeparadas extends AppCompatActivity {
    ImageView imagen2;
    PhotoViewAttacher photo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ecuacion_variables_separadas);
        ...
        imagen2 =(ImageView)findViewById(R.id.var2);
