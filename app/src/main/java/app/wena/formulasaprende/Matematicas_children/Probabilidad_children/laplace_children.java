...
public class laplace_children extends AppCompatActivity {
    ImageView imagen,ima2;
    PhotoViewAttacher photo,poto2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laplace_children);
        ...
        imagen =(ImageView)findViewById(R.id.lapla1);
        photo = new PhotoViewAttacher(imagen);

        ima2 =(ImageView)findViewById(R.id.lapla2);
