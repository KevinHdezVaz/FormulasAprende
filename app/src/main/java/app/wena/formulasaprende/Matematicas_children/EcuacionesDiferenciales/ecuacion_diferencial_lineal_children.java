...
public class ecuacion_diferencial_lineal_children extends AppCompatActivity {
    ImageView imagen2;
    PhotoViewAttacher photo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ecuacion_diferencial_lineal_children);
        ...
        imagen2 =(ImageView)findViewById(R.id.ultimaF);
