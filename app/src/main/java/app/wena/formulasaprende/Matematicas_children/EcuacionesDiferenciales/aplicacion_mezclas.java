...
public class aplicacion_mezclas extends AppCompatActivity {
    ImageView imagen2;
    PhotoViewAttacher photo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aplicacion_mezclas);
        ...
        imagen2 =(ImageView)findViewById(R.id.mezcls);
