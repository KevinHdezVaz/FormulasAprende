...
public class potenciaFracciones_children extends AppCompatActivity {
    ImageView imagen;
    PhotoViewAttacher photo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_potencia_fracciones_children);
        ...
        imagen =(ImageView)findViewById(R.id.potencia_zoom);
